...
def plot_barChart(method, name_method):
    ...
    blue2 = '#7a0c0c'   #'cornflowerblue'
    colors = [blue2, blue2, blue2, blue2, blue2, blue2, blue2, blue2, '#253035']  # different color for the 'Model' bar
    ...
    plt.savefig(SAVE_PLOT_PATH + 'thesis_' + name_method + '.png', transparent=True)
    plt.show()
...
def plot_STM_confMatrix(method, name_method):
    ...
    caxes = axes.matshow(conf_matr, cmap=plt.cm.Reds)
    ...
    plt.savefig(SAVE_PLOT_PATH + 'matrix_' + name_method + '.png', transparent=True)
