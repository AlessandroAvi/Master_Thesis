...
% introduzione a uso di ml su mcu
% paralre dei problemi che hannoi deviices, paralre del aatto che fanno solo inference
% paralre di cosa servirebbe migliorare per usare ml su mcu
% paralre dei vantaggi dell uso di ml su iot
% nominare qualche state of the art application?
...
\begin{table}[]
\caption{Table showing the overall accuracy, inference times and memory use for each method during testing of the gesture recognition application.}
\label{table:nucleosmalltable}
\begin{tabular}{|c|c|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Method\\ used\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Accuracy\\ {[}\%{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Avrg inference\\ time frozen\\ model  {[}ms{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Avrg inference\\ time OL\\ layer {[}ms{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Max allocated\\ RAM\\ {[}kB{]}\end{tabular}} \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}OL\\ \: \end{tabular}}                                                    & 86.13                                                                & 10.65                                                                                           & 0.99                                                                                       & 26.1                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}OL\\ batch\end{tabular}}    & 86.26                                                                & 10.65                                                                                           & 1.54                                                                                       & 29.8                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}OL V2\\ \: \end{tabular}}                                                 & 87.98                                                                & 10.65                                                                                           & 1.03                                                                                       & 26.1                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}OL V2\\ batch\end{tabular}} & 87.98                                                                & 10.65                                                                                           & 1.11                                                                                       & 29.8                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}LWF\\ \: \end{tabular}}                                                   & 87.61                                                                & 10.65                                                                                           & 3.45                                                                                       & 29.9                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}LWF\\ batch\end{tabular}}   & 86.50                                                                & 10.65                                                                                           & 3.26                                                                                       & 29.9                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}CWR\\ \: \end{tabular}}                                                   & 88.47                                                                & 10.65                                                                                           & 2.11                                                                                       & 29.9                                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}MY\\ ALG \end{tabular}}                                                & 86.87                                                                & 10.65                                                                                           & 3.54                                                                                       & 29.9                                                                            \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=140mm]{Figures/Chapter5/STM_barPlot_OL.jpg} 

    \caption{Bar plot and confusion matrix showing the results from the testing session performed with TinyOL algorithm.}
    \label{fig:letter_res_OL}    
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=140mm]{Figures/Chapter5/STM_barPlot_OL_batch.jpg} 
    \caption{Bar plot and confusion matrix showing the results from the testing session performed with TinyOL algorithm with batches.}
...
\multicolumn{1}{c|}{\multirow{2}{*}{\textbf{Method}}}                             & \multirow{2}{*}{\textbf{Parameter}} & \multicolumn{8}{c|}{\textbf{Class}}                                                                                                                                                                                                                                           & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Learning\\ rate\end{tabular}}} \\
\multicolumn{1}{c|}{}                                                             &                                     & \multicolumn{1}{c|}{\textbf{A}} & \multicolumn{1}{c|}{\textbf{E}} & \multicolumn{1}{c|}{\textbf{I}} & \multicolumn{1}{c|}{\textbf{O}} & \multicolumn{1}{c|}{\textbf{U}} & \multicolumn{1}{c|}{\textbf{B}} & \multicolumn{1}{c|}{\textbf{R}} & \multicolumn{1}{c|}{\textbf{M}} &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{OL}}                                                      & Accuracy                            & 0.92                            & 0.93                            & 0.83                            & 0.87                            & 0.86                            & 0.78                            & 0.83                            & 0.93                            & \multirow{3}{*}{0.001}                                                            \\
                                                                                  & Precision                           & 0.92                            & 0.93                            & 0.85                            & 0.87                            & 0.86                            & 0.78                            & 0.83                            & 0.92                            &                                                                                   \\
                                                                                  & F1 score                            & 0.92                            & 0.93                            & 0.84                            & 0.87                            & 0.86                            & 0.78                            & 0.83                            & 0.92                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}OL\\ batches\end{tabular}}}    & Accuracy                            & 0.89                            & 0.96                            & 0.88                            & 0.90                            & 0.89                            & 0.76                            & 0.79                            & 0.93                            & \multirow{3}{*}{0.0001}                                                           \\ \cline{2-2}
                                                                                  & Precision                           & 0.93                            & 0.97                            & 0.89                            & 0.91                            & 0.85                            & 0.75                            & 0.78                            & 0.93                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.91                            & 0.96                            & 0.88                            & 0.90                            & 0.87                            & 0.75                            & 0.78                            & 0.93                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{OL V2}}                                                   & Accuracy                            & 0.90                            & 0.94                            & 0.82                            & 0.92                            & 0.97                            & 0.83                            & 0.82                            & 0.92                            & \multirow{3}{*}{0.001}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.87                            & 0.94                            & 0.91                            & 0.93                            & 0.91                            & 0.82                            & 0.83                            & 0.92                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.88                            & 0.94                            & 0.86                            & 0.92                            & 0.94                            & 0.82                            & 0.82                            & 0.92                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}OL V2\\ batches\end{tabular}}} & Accuracy                            & 0.88                            & 0.94                            & 0.83                            & 0.94                            & 0.97                            & 0.80                            & 0.82                            & 0.94                            & \multirow{3}{*}{0.001}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.87                            & 0.93                            & 0.94                            & 0.93                            & 0.93                            & 0.79                            & 0.81                            & 0.94                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.87                            & 0.93                            & 0.88                            & 0.93                            & 0.95                            & 0.79                            & 0.81                            & 0.94                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{LWF}}                                                     & Accuracy                            & 0.93                            & 0.94                            & 0.86                            & 0.92                            & 0.89                            & 0.78                            & 0.83                            & 0.94                            & \multirow{3}{*}{0.001}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.93                            & 0.96                            & 0.86                            & 0.90                            & 0.88                            & 0.78                            & 0.83                            & 0.94                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.93                            & 0.95                            & 0.86                            & 0.91                            & 0.88                            & 0.78                            & 0.83                            & 0.94                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}LWF\\ batches\end{tabular}}}   & Accuracy                            & 0.90                            & 0.96                            & 0.84                            & 0.87                            & 0.89                            & 0.78                            & 0.83                            & 0.92                            & \multirow{3}{*}{0.0007}                                                           \\ \cline{2-2}
                                                                                  & Precision                           & 0.89                            & 0.96                            & 0.85                            & 0.87                            & 0.90                            & 0.78                            & 0.83                            & 0.92                            &                                                                                   \\ \cline{2-2}
...
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}MY\\ ALG\end{tabular}}}        & Accuracy                            & 0.92                            & 0.94                            & 0.94                            & 0.91                            & 0.80                            & 0.78                            & 0.80                            & 0.94                            & \multirow{3}{*}{0.005}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.90                            & 0.94                            & 0.93                            & 0.90                            & 0.82                            & 0.76                            & 0.81                            & 0.96                            &                                                                                   \\ \cline{2-2}
...
For the image recognition application the simulation step has not been performed. Once the framework proved to be working correctly on the Nucleo and on the laptop it was implemented also to be working on the OpenMV camera. Also for this case the testing is performed on the last $20 \%$ of the dataset meaning that 4000 samples are used for training and 1000 are used for pseudo testing. Table \ref{table:openmv_smalltable} contains an overview of the accuracy and inference time results, table \ref{table:openmv_bigtable} contains the detailed results about accuracy, precision and F1 score. Figures \ref{fig:openmv_res_OL}, \ref{fig:openmv_res_OL_batch}, \ref{fig:openmv_res_OL_v2}, \ref{fig:openmv_res_OL_v2_batch}, \ref{fig:openmv_res_LWF}, \ref{fig:openmv_res_LWF_batch}, \ref{fig:openmv_res_CWR} contain bar plots and confusion matrices showing the results of the testing procedure.



\begin{table}[]
\caption{Table showing the overall accuracy and inference times for each method during testing of the digits recognition application.}
\label{table:openmv_smalltable}
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Method\\ used\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Accuracy\\ {[}\%{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Avrg inference\\ time frozen\\ model {[}ms{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Avrg inference\\ time OL\\ layer {[}ms{]}\end{tabular}} \\ \hline
\textbf{OL}                                                    & 94.39                                                                & 15.87                                                                                          & 3.02                                                                                       \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}OL\\ batch\end{tabular}}    & 95.4                                                                 & 15.88                                                                                          & 3.35                                                                                       \\ \hline
\textbf{OL V2}                                                 & 94.39                                                                & 15.87                                                                                          & 2.13                                                                                       \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}OL V2\\ batch\end{tabular}} & 93.09                                                                & 15.88                                                                                          & 4.24                                                                                       \\ \hline
\textbf{LWF}                                                   & 95.2                                                                 & 15.89                                                                                          & 4.86                                                                                       \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}LWF\\ batch\end{tabular}}   & 94.99                                                                & 15.88                                                                                          & 5.20                                                                                       \\ \hline
\textbf{CWR}                                                   & 95.7                                                                 & 15.86                                                                                          & 3.32                                                                                       \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}MY\\ ALG\end{tabular}}      & 94.69                                                                & 15.88                                                                                          & 6.14                                                                                       \\ \hline
\end{tabular}
\end{table}
...
\multicolumn{1}{c|}{\multirow{2}{*}{\textbf{Method}}}                             & \multirow{2}{*}{\textbf{Parameter}} & \multicolumn{10}{c|}{\textbf{Class}}                                                                                                                                                                                                                                                                                                              & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Learning\\ rate\end{tabular}}} \\
\multicolumn{1}{c|}{}                                                             &                                     & \multicolumn{1}{c|}{\textbf{0}} & \multicolumn{1}{c|}{\textbf{1}} & \multicolumn{1}{c|}{\textbf{2}} & \multicolumn{1}{c|}{\textbf{3}} & \multicolumn{1}{c|}{\textbf{4}} & \multicolumn{1}{c|}{\textbf{5}} & \multicolumn{1}{c|}{\textbf{6}} & \multicolumn{1}{c|}{\textbf{7}} & \multicolumn{1}{c|}{\textbf{8}} & \multicolumn{1}{c|}{\textbf{9}} &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{OL}}                                                      & Accuracy                            & 0.99                            & 0.95                            & 0.95                            & 0.95                            & 0.93                            & 0.95                            & 0.97                            & 0.93                            & 0.93                            & 0.90                            & \multirow{3}{*}{0.005}                                                            \\
...
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}OL\\ batches\end{tabular}}}    & Accuracy                            & 0.99                            & 0.98                            & 0.96                            & 0.97                            & 0.95                            & 0.96                            & 0.97                            & 0.91                            & 0.93                            & 0.94                            & \multirow{3}{*}{0.005}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.95                            & 0.94                            & 0.96                            & 0.95                            & 0.95                            & 0.96                            & 0.98                            & 0.96                            & 0.96                            & 0.93                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.97                            & 0.96                            & 0.96                            & 0.96                            & 0.95                            & 0.96                            & 0.97                            & 0.93                            & 0.94                            & 0.93                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{OL V2}}                                                   & Accuracy                            & 1.00                            & 0.99                            & 0.91                            & 0.91                            & 0.93                            & 0.95                            & 0.97                            & 0.93                            & 0.93                            & 0.93                            & \multirow{3}{*}{0.005}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.99                            & 0.95                            & 0.95                            & 0.98                            & 0.95                            & 0.97                            & 0.97                            & 0.94                            & 0.95                            & 0.93                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.99                            & 0.91                            & 0.93                            & 0.94                            & 0.94                            & 0.96                            & 0.97                            & 0.93                            & 0.94                            & 0.93                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}OL V2\\ batches\end{tabular}}} & Accuracy                            & 0.99                            & 1.00                            & 0.89                            & 0.93                            & 0.93                            & 0.96                            & 0.93                            & 0.90                            & 0.88                            & 0.91                            & \multirow{3}{*}{0.005}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 0.89                            & 0.83                            & 0.96                            & 0.97                            & 0.96                            & 0.94                            & 0.96                            & 0.94                            & 0.90                            & 0.93                            &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.97                            & 0.91                            & 0.92                            & 0.95                            & 0.94                            & 0.95                            & 0.94                            & 0.92                            & 0.89                            & 0.92                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{LWF}}                                                     & Accuracy                            & 0.99                            & 0.95                            & 0.94                            & 0.95                            & 0.96                            & 0.97                            & 0.99                            & 0.95                            & 0.92                            & 0.92                            & \multirow{3}{*}{0.005}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 1.00                            & 0.95                            & 0.94                            & 0.95                            & 0.96                            & 0.97                            & 0.98                            & 0.95                            & 0.93                            & 0.9                             &                                                                                   \\ \cline{2-2}
                                                                                  & F1 score                            & 0.99                            & 0.95                            & 0.94                            & 0.95                            & 0.96                            & 0.97                            & 0.98                            & 0.95                            & 0.92                            & 0.91                            &                                                                                   \\ \hline
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}LWF\\ batches\end{tabular}}}   & Accuracy                            & 0.99                            & 0.96                            & 0.96                            & 0.95                            & 0.96                            & 0.95                            & 0.98                            & 0.95                            & 0.91                            & 0.91                            & \multirow{3}{*}{0.005}                                                            \\ \cline{2-2}
                                                                                  & Precision                           & 1.00                            & 0.96                            & 0.95                            & 0.94                            & 0.96                            & 0.97                            & 0.97                            & 0.95                            & 0.92                            & 0.89                            &                                                                                   \\ \cline{2-2}
...
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}MY\\ ALG\end{tabular}}}        & Accuracy                            & 0.96                            & 0.98                            & 0.93                            & 0.93                            & 0.96                            & 0.95                            & 0.97                            & 0.94                            & 0.93                            & 0.93                            & \multirow{3}{*}{0.00001}                                                          \\ \cline{2-2}
...
From Table \ref{table:openmv_smalltable} considering the high accuracyes of the models it can be concluded that the CL trainin gperform was succesfult. This time the accuracy is higher than before, and also the varioation of accuracy between the strategeis is lower that experiment A. This is most probably due to the increased complexity of the modela nd the better quality of the dataset. From the first column of the table it can be said that all methods are able to maintain a quite high accuracy. The best performing is again the CWR method with an accuracy of $95.7 \%$, while the worst performing is TinyOL V2 with batches with an accuracy of $93.09 \%$. This time the drop of accuracy between the frozen model and the worst performing CL model is of only $6.7 \%$. The table again contains information related to the time of inference required for a training step. Again the time is divided in two parts, the inference performed on the frozen model by the built in tools and the time required for performing feed forward and training over the OL layer. Also in this application the time required for the inference on the frozen model is pretty much coinstant at it requires $10.56 ms$. On the other hand the times required for the CL step this time show a more distinct behaviour between methods. The fastest algorithms is TinyOL, which takes only $2.13 ms$, while the slowes is LWF with batches, whch takes $5.20 ms$. Again as before the reasosns of these results are the amount of computations required. The method TinyOL V2 requires inference on one classification layer but it applies back propagation only on a partion of the classification layer. The method LWF requires two inferences from two classification layers and it has to perform back proapgation on both.\\
The results obtained from the tables can be paired with the Fogures containing the bar plots and the conusion matrices. This time all methods show a good behaviour on all classes. With respect to the experiment A, there are no digits that get confused with other classes. This is the proof that demonstrated that the methods are well implemented, and the previous problem regarding the confusion between classes R and B was merely dependent on the similarity of the data pattern.\\
At last the same test regarding the study of the accuracy at the variation of the batch size were performed. Figure \ref{fig:openmv_batch_size} contains the plots that shows the results of the test.

\begin{figure}[h!]
    \centering
    \includegraphics[width=140mm]{Figures/Chapter5/batch_size_openmv.png} 
    \caption{Plot showing the variation of accuracy from each method with the increase of the batch size performed in the digits recognition experiment.}
    \label{fig:openmv_batch_size}    
\end{figure}

Also in this case the only two methods that showed a decrease in performace are TinyOL and TinyOL V2. All the other methods show a constant accuracy value for a batch size that goes from 1 to 256.
