...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 600, 1, NULL), \
}
...
#define AI_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 256, 1, NULL), \
}
...
#define AI_NETWORK_OUT_1_CHANNEL     (256)
#define AI_NETWORK_OUT_1_SIZE        (1 * 1 * 256)
